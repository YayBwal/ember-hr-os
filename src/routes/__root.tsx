  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <div className="text-xs font-mono uppercase tracking-[0.2em] text-primary">404</div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mandai" },
      {
        ...
        content:
          "Pipeline, operations, delivery, and payroll in one AI-driven enterprise workspace.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      const stored = window.localStorage.getItem("mandai-theme");
